...
public class YellowMonster extends Enemy {
    ...
    public YellowMonster(PlayScreen screen, float x, float y) {
        ...
        frames.add(new TextureRegion(screen.getAtlas().findRegion("yellowMonster"), 0, 0, 16, 24));
        frames.add(new TextureRegion(screen.getAtlas().findRegion("yellowMonster"), 16, 0, 16, 24));
        shell = new TextureRegion(screen.getAtlas().findRegion("yellowMonster"), 64, 0, 16, 24);
    ...
    public void update(float dt) {
        ...
        setPosition(b2body.getPosition().x - getWidth() / 2, b2body.getPosition().y - 8 / MainGame.PPM);
