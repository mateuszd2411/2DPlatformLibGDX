...
public class Raft extends Enemy {
    ...
    public Raft(PlayScreen screen, float x, float y) {
        ...
        stateTime = 0;
        setBounds(getX(), getY(), 120/ MainGame.PPM,45 / MainGame.PPM);
    }
    ...
    protected void defineEnemy() {
        ...
        vertice[0] = new Vector2(-20,8).scl(2 / MainGame.PPM);
        vertice[1] = new Vector2(20,8).scl(2 / MainGame.PPM);
        vertice[2] = new Vector2(-20,3).scl(2 / MainGame.PPM);
        vertice[3] = new Vector2(20,3).scl(2 / MainGame.PPM);
        head.set(vertice);
